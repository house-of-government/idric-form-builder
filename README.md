...
The important target is not programmers building forms. It is a parent filling out a school lunch form and expecting it to work.
...
The form builder should instead represent the field structurally, roughly as:
...
The same schema should be usable by different renderers and different export adapters. That separation is the point: form logic should not become networking logic, and storage conventions should not become burdens placed on the person filling out the form.
